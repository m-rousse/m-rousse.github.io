...
<div><pre class="language-bash line-numbers">
<code class="language-bash">root@kali:~/sCTF/Rev2# ./rev2
What is the magic password?
51239555
...
<div><pre class="language-bash line-numbers">
<code class="language-bash">root@kali:/tmp/jar# unzip Secure_Text_Saver.jar
